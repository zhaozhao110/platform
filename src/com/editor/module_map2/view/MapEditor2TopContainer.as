package com.editor.module_map2.view
{
	...
	public class MapEditor2TopContainer extends UIHBox
	{
		public function MapEditor2TopContainer()
		{
			super();
			create_init();
		}
		...
		private var menu_xml:XML = <root>
			...
			<menuitem label="操作" >
				...
				<menuitem label="放置阶梯(黄色)" data="ladderBtn"/>
				<menuitem label="放置障碍(红色)" data="HINDERBtn"/>
				<menuitem label="放置透明(白色)" data="alphaBtn"/>
				<menuitem label="取消放置(蓝色)" data="cancelRoadBtn"/>
				<menuitem label="框选" data="rectBtn"/>
			</menuitem>
		</root>
