package com.editor.modules.pop.editEvent
{
	...
	public class AppEditEventPopWin extends AppPopupWithEmptyWin
	{
		public function AppEditEventPopWin()
		{
			super()
			create_init();
		}
		...
		private function create_init():void
		{
			...
			event_vb.itemRenderer = AppEditEventItemRenderer;
			event_vb.width = 470;
			event_vb.height = 305;
		...
		override protected function __init__():void
		{
			...
			popupSign  		= PopupwinSign.AppEditEventPopWin_sign;
			isModel    		= false;		
			enabledDrag    	= true;
			super.__init__();
		}
		...
		{
			super.createPopWin();
			registerMediator(new AppEditEventPopWinMediator(this))
		}
		
		override public function delPopwin():void
		{
			super.delPopwin()
			removeMediator(AppEditEventPopWinMediator.NAME)
		}
