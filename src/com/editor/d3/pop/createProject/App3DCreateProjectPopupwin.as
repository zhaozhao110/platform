package com.editor.d3.pop.createProject
{
	 ...
	 * 新建项目
	 */ 
	public class App3DCreateProjectPopupwin extends AppPopupWithEmptyWin
	{
		public function App3DCreateProjectPopupwin()
		{
			super()
			create_init();
		}
		...
		private function create_init():void
		{
			...
			nameForm.width = 220
			nameForm.height = 22
			nameForm.formLabel = "3D项目名称："
			form_a.push(nameForm);
			
			var hb1:UIHBox = new UIHBox();
			hb1.width = 250;
			hb1.height = 22;
			hb1.formLabel = "3D项目目录："
			form_a.push(hb1);
		...
		override protected function __init__():void
		{
			...
			popupSign  		= PopupwinSign.App3DCreateProjectPopupwin_sign;
			isModel    		= true;		
			enabledDrag    	= true;
			super.__init__();
		}
		...
		{
			super.createPopWin();
			registerMediator(new App3DCreateProjectPopwinMediator(this))
		}
				
		override public function delPopwin():void
		{
			super.delPopwin()
			removeMediator(App3DCreateProjectPopwinMediator.NAME)
		}
	}
}