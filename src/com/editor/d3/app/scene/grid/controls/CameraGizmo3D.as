package com.editor.d3.app.scene.grid.controls
{
	...
	public class CameraGizmo3D extends ObjectContainer3D implements ISceneRepresentation 
	{
		...
		public var target:D3MapItemCamera;
		...
		public function CameraGizmo3D(originalCamera:Camera3D)
		{
			...
			var tmp_m:Mesh = new Mesh(new CubeGeometry(100, 100, 100), camMat);
			tmp_m.castsShadows = false;
			_orthoCube.addChild(tmp_m);
		...
		public function updateRepresentation():void 
		{
			...
			/*var dist:Vector3D = sceneMM.currCamera.scenePosition.subtract(sceneObject.scenePosition);
			...
			//_frustum.visible = _perspectiveCone.visible && (_overrideObjectSelection || sceneMM.selectedObject == _representation);
			_frustum.visible = selected;
			var oldOrthoCubeVis:Boolean = _orthoPlaneNear.visible;
			_orthoCube.visible = !_perspectiveCone.visible;
			_orthoPlaneNear.visible = _orthoPlaneFar.visible = _orthoCube.visible && (_overrideObjectSelection || sceneMM.selectedObject == _representation);
