	...
	{	
		...
		protected function handleMouseDown(e:MouseEvent3D):void
		{
			...
			*/
			...
			click2.x = stage.mouseX;
			click2.y = stage.mouseY;			
		...
		protected function handleMouseMove(e:MouseEvent):void
		{
			...
			var rx:Number = (stage.mouseX - click2.x);
			var ry:Number = -(stage.mouseY - click2.y);			
			
			var trans:Number = (dx+dy)/2 * (behindGizmoPlane ? 1 : -1);
			//trace(trans,stage.mouseX,click.x,currentAxis);
			switch(currentAxis)
			{
				case "xAxis":
				...
				case "yAxis":
					...
					var yv1:Vector3D = camera.downVector;
