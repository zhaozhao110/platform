package com.editor.d3.app.scene.grid.controls
{
	...
	public class Gizmo3DBase extends ObjectContainer3D
	{
		...
		public function update():void
		{
			...
			var dist:Vector3D = sceneMM.currCamera.scenePosition.subtract(content.scenePosition);
			...
			ambientLight.direction = sceneMM.currCamera.forwardVector;
