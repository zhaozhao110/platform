package com.editor.d3.view.particle.behaviors.plug.colorTween.multiplier.cell
{
	...
	public class Beh_color_mult_start extends UIVBox
	{
		public function Beh_color_mult_start()
		{
			super();
			create_init();
		}
