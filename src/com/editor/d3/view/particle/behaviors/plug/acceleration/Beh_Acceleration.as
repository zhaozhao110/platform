package com.editor.d3.view.particle.behaviors.plug.acceleration
{
	...
	public class Beh_Acceleration extends ParticleAttriPlugBase
	{
		public function Beh_Acceleration()
		{
			super();
		}
		...
		override protected function create_init():void
		{
			...
			startTimeOne.label = "acceleration"
		...
		override public function saveObject():void
		{
			...
			plusObj.clear();
			plusObj.putAttri("acceleration",startTimeOne.getObject());
		}
		...
		override public function changeAnim():void
		{
			...
			if(plusObj.getAttri("acceleration") == null){
				reset();
				saveObject()
			}
			startTimeOne.setValue(plusObj.getAttri("acceleration"));
		}
