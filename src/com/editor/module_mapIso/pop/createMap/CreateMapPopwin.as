package com.editor.module_mapIso.pop.createMap
{
	...
	public class CreateMapPopwin extends AppPopupWithEmptyWin
	{
		public function CreateMapPopwin()
		{
			super()
			create_init();
		}
		...
		override protected function __init__():void
		{
			...
			popupSign  		= PopupwinSign.CreateMapPopwin_sign;
			isModel    		= true;		
			enabledDrag    	= true;
			super.__init__();
		}
		...
		{
			super.createPopWin();
			registerMediator(new CreateMapPopwinMediator(this))
		}
		
		override public function delPopwin():void
		{
			super.delPopwin()
			removeMediator(CreateMapPopwinMediator.NAME)
		}
	}
}