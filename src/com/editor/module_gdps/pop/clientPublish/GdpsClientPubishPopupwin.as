package com.editor.module_gdps.pop.clientPublish
{
	...
	public class GdpsClientPubishPopupwin extends AppPopupWithEmptyWin
	{
		public function GdpsClientPubishPopupwin()
		{
			super();
			create_init();
		}
		...
		override protected function __init__():void
		{
			...
			popupSign  		= GDPSPopupwinSign.GdpsClientPublishPopupwin_sign;
			isModel    		= true;		
			enabledDrag    	= true;
			super.__init__();
		}
		...
		{
			super.createPopWin();
			registerMediator(new GdpsClientPubishPopupwinMediator(this));
		}
		
		override public function delPopwin():void
		{
			super.delPopwin();
			removeMediator(GdpsClientPubishPopupwinMediator.NAME);
		}
	}
}