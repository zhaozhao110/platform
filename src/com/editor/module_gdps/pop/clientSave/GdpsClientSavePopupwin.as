package com.editor.module_gdps.pop.clientSave
{
	...
	public class GdpsClientSavePopupwin extends AppPopupWithEmptyWin
	{
		public function GdpsClientSavePopupwin()
		{
			super();
			create_init();
		}
		...
		public var client_svn_version:UITextInput;
		...
		private function create_init():void
		{
			...
			client_svn_version = new UITextInput();
			client_svn_version.width = 90;
			client_svn_version.editable = false;
			hbox2.addChild(client_svn_version);
		...
		override protected function __init__():void
		{
			...
			popupSign  		= GDPSPopupwinSign.GdpsClientSavePopupwin_sign;
			isModel    		= true;		
			enabledDrag    	= true;
			super.__init__();
		}
		...
		{
			super.createPopWin();
			registerMediator(new GdpsClientSavePopupwinMediator(this));
		}
		
		override public function delPopwin():void
		{
			super.delPopwin();
			removeMediator(GdpsClientSavePopupwinMediator.NAME);
		}
	}
}