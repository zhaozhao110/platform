package com.editor.module_gdps.pop.resPublish
{
	...
	public class GdpsResPublishPopupwinMediator extends AppDestroyPopupwinMediator
	{
		public static const NAME:String = "GdpsResPublishPopupwinMediator";
		
		private var confItem:AppModuleConfItem; //左侧菜单请求的信息
		private var selectedId:String; //当前批次号
		
		public function GdpsResPublishPopupwinMediator(viewComponent:Object = null)
		{
			super(NAME, viewComponent);
		}
		public function get publishResPopwin():GdpsResPublishPopupwin
		{
			return viewComponent as GdpsResPublishPopupwin;
		}
		...
		override public function onRegister():void
		{
			...
			GDPSDataManager.getInstance().registerXMLSocket(GdpsXmlSocketConst.client_type_res);
		...
		private function initView():void
		{
			...
			publishResPopwin.revision_tip.htmlText = "更新SVN版本号: " + ColorUtils.addColorTool(grid.selectedItem.NResRevision,0xff0000);
		...
		public function reactToSubmitBtnClick(evt:MouseEvent):void
		{
			...
			mes.info = "您确认需要发布当前RES资源批次【" + ColorUtils.addColorTool(selectedId,0xff0000) + "】到外网测试服吗？";
		...
		private function submitBtnFunc():Boolean
		{
			...
			http.conn(GDPSServices.get_resData_publish_url);
