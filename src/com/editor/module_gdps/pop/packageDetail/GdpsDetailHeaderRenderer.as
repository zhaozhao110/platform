package com.editor.module_gdps.pop.packageDetail
{
	...
	public class GdpsDetailHeaderRenderer extends SandyBoxItemRenderer
	{
		public function GdpsDetailHeaderRenderer()
		{
			super();
		...
		{
			dataBaseMedi().selectedBoxHandler(checkBox.selected);
		}
