package com.editor.module_gdps.pop.resSave
{
	...
	import com.editor.module_gdps.view.publishRes.mediator.GdpsPublishResDataGridMediator;
	...
	public class GdpsResSavePopupwinMediator extends AppDestroyPopupwinMediator
	{
		public static const NAME:String = "GdpsResSavePopupwinMediator";
		
		public function GdpsResSavePopupwinMediator(view:Object = null)
		{
			super(NAME , view);
		}
		public function get saveWin():GdpsResSavePopupwin
		{
			return viewComponent as GdpsResSavePopupwin;
		}
		...
		{
			return retrieveMediator(GdpsPublishResDataGridMediator.NAME + menuId) as GdpsPublishResDataGridMediator;
		}
		...
		public function reactToSvnBtnClick(event:MouseEvent):void
		{
			...
			dat.data = { "type" : "R", "source" : GDPSDataManager.res_data_type };
		...
		private function showColumnDataCallBack(a:*):void
		{
			...
			saveWin.res_svn_version.text = columns[0].NResRevision;
		}
		...
		public function reactToSaveBtnClick(evt:MouseEvent):void
		{
			...
			if(saveWin.res_svn_version.text == ""){
			...
			formValues.SScope = GDPSDataManager.res_data_type;
			formValues.SDesc = saveWin.SDesc.text;
			formValues.NResRevision = saveWin.res_svn_version.text;
			//请求后台
			var http:GdpsHttpServiceLocator = new GdpsHttpServiceLocator();
