package com.editor.module_gdps.view.productManage
{
	...
	public class GdpsProductManagerContainer extends UICanvas
	{
		public function GdpsProductManagerContainer()
		{
			super();
			create_init();
		}
		
		public var toolBar:GdpsProductManagerToolBar;
		...
		private function create_init():void
		{
			...
			toolBar = new GdpsProductManagerToolBar();
