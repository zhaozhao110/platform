package com.editor.module_gdps.view.publishClient.mediator
{
	...
	public class GdpsPublishClientToolBarMediator extends AppMediator
	{
		public static const NAME:String = "GdpsPublishClientToolBarMediator";
		...
		public function GdpsPublishClientToolBarMediator(viewComponent:Object = null, _confItem:AppModuleConfItem = null)
		{
		...
		{
			return viewComponent as GdpsPublishClientToolBar;
		}
		...
		private function menuHandler(s:String):void
		{
			...
			if (btnName == "add" || btnName == "update")
			{
				...
				dat.popupwinSign = GDPSPopupwinSign.GdpsClientSavePopupwin_sign;
			...
			else if (btnName == "publish")
			{
				...
				dat.popupwinSign = GDPSPopupwinSign.GdpsClientPublishPopupwin_sign;
				dat.openByAirData = new OpenPopByAirOptions();
				openPopupwin(dat);
			}
