package com.editor.module_gdps.view.publishClient.mediator
{
	...
	public class GdpsPublishClientDataGridMediator extends AppMediator
	{
		public static const NAME:String = "GdpsPublishClientDataGridMediator";
		...
		public function GdpsPublishClientDataGridMediator(viewComponent:Object = null, _confItem:AppModuleConfItem = null)
		{
		...
		{
			var http:GdpsHttpServiceLocator = new GdpsHttpServiceLocator();
			http.args2 = { "pageNo": pageNo, "pageLimit": pageLimit, "SScope" : GDPSDataManager.client_data_type};/*, "tableId": confItem.extend.queryTableId */
