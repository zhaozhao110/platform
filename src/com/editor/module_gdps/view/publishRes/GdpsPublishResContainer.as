package com.editor.module_gdps.view.publishRes
{
	...
	public class GdpsPublishResContainer extends UICanvas
	{
		public function GdpsPublishResContainer()
		{
			super();
			create_init();
		}
		
		public var toolBar:GdpsPublishResToolBar;
		...
		private function create_init():void
		{
			...
			toolBar = new GdpsPublishResToolBar();
