package com.editor.module_gdps.view.publishRes.mediator
{
	...
	public class GdpsPublishResDataGridMediator extends AppMediator
	{
		public static const NAME:String = "GdpsPublishResDataGridMediator";
		...
		public function GdpsPublishResDataGridMediator(viewComponent:Object = null, _confItem:AppModuleConfItem = null)
			{
		...
		{
			var http:GdpsHttpServiceLocator = new GdpsHttpServiceLocator();
			http.args2 = { "pageNo": pageNo, "pageLimit": pageLimit, "SScope" : GDPSDataManager.res_data_type};/*, "tableId": confItem.extend.queryTableId */
