package com.editor.module_gdps.view.dataManage
{
	...
	public class GdpsDataManagerContainer extends UICanvas
	{
		public function GdpsDataManagerContainer()
		{
			super();
			create_init();
		}
		
		public var toolBar:GdpsDataManagerToolBar;
		...
		private function create_init():void
		{
			...
			toolBar = new GdpsDataManagerToolBar();
			...
			infoText.text = "当前模块提供游戏基础表数据的xls导入、历史数据版本比较、相关xml，swf配置文件生成等功能。";
