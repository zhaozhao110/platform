package com.editor.module_gdps.view.dataManage.mediator
{
	...
	public class GdpsDataManagerDataGridMediator extends AppMediator
	{
		public static const NAME:String = "GdpsDataManagerDataGridMediator";
		...
		public function GdpsDataManagerDataGridMediator(viewComponent:Object = null, _confItem:AppModuleConfItem = null)
		{
		...
		private function showDataManageData(a:*):void
		{
			...
			var modifier:String = value.modifier;
			var modifyTime:String = value.modifyTime;
			contentMediator.infoText.text = "当前显示版本：编辑版	 最后修改人：" + modifier + "	 最后修改时间：" + modifyTime;
		...
		private function get contentMediator():GdpsDataManagerContainerMediator
		{
			return retrieveMediator(GdpsDataManagerContainerMediator.NAME + confItem.menuId) as GdpsDataManagerContainerMediator;
		}
	}
}