package com.editor.module_gdps.view.publishServer.mediator
{
	...
	public class GdpsPublishServerToolBarMediator extends AppMediator
	{
		public static const NAME:String = "GdpsPublishServerToolBarMediator";
		...
		public function GdpsPublishServerToolBarMediator(viewComponent:Object = null, _confItem:AppModuleConfItem = null)
		{
		...
		{
			return viewComponent as GdpsPublishServerToolBar;
		}
		...
		private function menuHandler(s:String):void
		{
			...
			if (btnName == "add" || btnName == "update")
			{
				...
				dat.popupwinSign = GDPSPopupwinSign.GdpsServerSavePopupwin_sign;
			...
			else if (btnName == "publish")
			{
				...
				dat.popupwinSign = GDPSPopupwinSign.GdpsServerPublishPopupwin_sign;
				dat.openByAirData = new OpenPopByAirOptions();
				openPopupwin(dat);
			}
