package com.editor.module_gdps.view.publishServer.mediator
{
	...
	public class GdpsPublishServerDataGridMediator extends AppMediator
	{
		public static const NAME:String = "GdpsPublishServerDataGridMediator";
		
		/**
		 * PublishResModuleContentMediator传递的左侧菜单节点数据对象
		 * @default
		 */
		private var confItem:AppModuleConfItem = null;
		
		public function GdpsPublishServerDataGridMediator(viewComponent:Object = null, _confItem:AppModuleConfItem = null)
		{
		...
		{
			var http:GdpsHttpServiceLocator = new GdpsHttpServiceLocator();
			http.args2 = { "pageNo": pageNo, "pageLimit": pageLimit, "SScope" : GDPSDataManager.server_data_type};/*, "tableId": confItem.extend.queryTableId */
		...
		private function showPackagingData(a:*):void
		{
			...
			packaging_grid.dataProvider = value;
			packaging_page_bar.pageData = value.length;
			packaging_page_bar.totalCount = a.page.totalRowCount;
