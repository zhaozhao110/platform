package com.editor.project_pop.tweenExplorer
{
	...
	public class TweenExplorerPopwinTab2 extends UIVBox
	{
		public function TweenExplorerPopwinTab2()
		{
			super();
			//create_init();
		}
		...
		override public function delay_init():Boolean
		{
			...
			loader.width = 400;
			loader.height = 200
			loader.loadURL(AppGlobalConfig.instance.config_hash.find("transform_swf"))
			addChild(loader);
