package com.editor.project_pop.tweenExplorer
{
	...
	public class TweenExplorerPopwinTab3 extends UIVBox
	{
		public function TweenExplorerPopwinTab3()
		{
			super();
			//create_init();
		}
		...
		override public function delay_init():Boolean
		{
			...
			loader.width = 550;
			loader.height = 500
			loader.loadURL(AppGlobalConfig.instance.config_hash.find("bmp_draw"))
			addChild(loader);
