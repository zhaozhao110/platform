package com.editor.project_pop.tweenExplorer
{
	...
	public class TweenExplorerPopwinTab4 extends UIVBox
	{
		public function TweenExplorerPopwinTab4()
		{
			super();
			//create_init();
		}
		...
		override public function delay_init():Boolean
		{
			...
			loader.width = 950;
			loader.height = 620
			loader.loadURL(AppGlobalConfig.instance.config_hash.find("flexComp"))
			addChild(loader);
