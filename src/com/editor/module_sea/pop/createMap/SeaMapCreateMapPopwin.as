package com.editor.module_sea.pop.createMap
{
	...
	public class SeaMapCreateMapPopwin extends AppPopupWithEmptyWin
	{
		public function SeaMapCreateMapPopwin()
		{
			super()
			create_init();
		}
		...
		override protected function __init__():void
		{
			...
			popupSign  		= PopupwinSign.SeaMapCreateMapPopwin_sign;
			isModel    		= true;		
			enabledDrag    	= true;
			super.__init__();
		}
		...
		{
			super.createPopWin();
			registerMediator(new SeaMapCreateMapPopwinMediator(this))
		}
		
		override public function delPopwin():void
		{
			super.delPopwin()
			removeMediator(SeaMapCreateMapPopwinMediator.NAME)
		}
